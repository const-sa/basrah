...
class NotificationTemplatesSeeder extends Seeder
{
    ...
    private function templates(): array
    {
        return [
            ...
            // General is every category's fallback, so it covers each automatic event.
            [
                'category' => 'general',
                'event' => 'reminder',
                'title' => 'تذكير بالموعد — عام',
                'body' => implode("\n", [
                    'مرحباً {name} 👋',
                    'تذكير بحجزكم رقم {reference} لدى {business_name}.',
                    'الوحدة: {unit}',
                    'الموعد: {date} — {period}',
                    'المتبقي: {remaining}',
                    'نتشرّف باستقبالكم 🌿',
            ...
            [
                ...
                'title' => 'تذكير بالمتبقي — عام',
                'body' => implode("\n", [
                    'مرحباً {name} 👋',
                    'تذكير بالمبلغ المتبقي على حجزكم رقم {reference}.',
                    'الوحدة: {unit}',
                    'الموعد: {date}',
                    'إجمالي الحجز: {total}',
                    'المسدَّد: {paid}',
                    'المتبقي: {remaining}',
                    'نرجو السداد قبل الموعد. شكراً لكم.',
                ]),
            ],
            [
                'category' => 'general',
                'event' => 'payment',
                'title' => 'إشعار سداد — عام',
                'body' => implode("\n", [
                    'مرحباً {name} 👋',
                    'تم استلام مبلغ {amount} على الحجز رقم {reference} ✅',
                    'الوحدة: {unit}',
                    'المتبقي: {remaining}',
                    'شكراً لكم — {business_name}',
                ]),
            ],
            [
                'category' => 'general',
                ...
                'body' => implode("\n", [
                    'مرحباً {name} 👋',
                    'مرفق سند قبض {payment_type} على الحجز رقم {reference} 🧾',
                    'المبلغ: {amount}',
                    'الطريقة: {method}',
                    'المتبقي: {remaining}',
            ...
            [
                'category' => 'general',
                'event' => 'cancellation',
                'title' => 'إشعار إلغاء — عام',
                'body' => implode("\n", [
                    'مرحباً {name} 👋',
                    'نفيدكم بإلغاء الحجز رقم {reference}.',
                    'الوحدة: {unit}',
                    'الموعد: {date}',
                    'السبب: {reason}',
            ...
            [
                ...
                'body' => implode("\n", [
                    'مرحباً {name} 👋',
                    'مرفق سند قبض {payment_type} على حجز الشاليه رقم {reference} 🧾',
                    'الشاليه: {unit}',
                    'المبلغ: {amount}',
                    'الطريقة: {method}',
                    'المتبقي: {remaining}',
            ...
            [
                ...
                'body' => implode("\n", [
                    'مرحباً {name} 👋',
                    'مرفق سند قبض {payment_type} على حجز القاعة رقم {reference} 🧾',
                    'القاعة: {unit}',
                    'المبلغ: {amount}',
                    'الطريقة: {method}',
                    'المتبقي: {remaining}',
