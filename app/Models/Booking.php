...
class Booking extends Model
{
    ...
    /**
     * حالات الحجز الأربع — حالة سدادٍ لا مرحلة في دورة حياة.
     *
     * الحجز عند هذا العميل يُقرأ بما سُدِّد عليه: عربونٌ قُبض، أو مبلغٌ اكتمل.
     * وما خرج عن ذلك فمؤجلٌ أو ملغى. لا «دخول» ولا «خروج» هنا: تسجيلهما كان
     * خطوةً يمرّ بها الموظف على كل حجز بلا أثرٍ يقرؤه أحد.
     *
     * «متاح» ليست حالة حجز بل غياب الحجز: التقويم يعرضها للوحدة أو اليوم
     * الخالي، فلا موضع لها في هذا الجدول.
     */
    public const STATUSES = [
        'deposit_paid' => 'مدفوع العربون',
        'paid_in_full' => 'مسدد كامل',
        'postponed' => 'مؤجل',
        'cancelled' => 'ملغى',
    ];
     ...
     *
     * الحجز المدفوع عربونه يحجز التاريخ كالمسدَّد كاملًا، وإلا بيع اليوم
     * مرتين قبل اكتمال المبلغ. والمؤجل خارجها: التأجيل يحرّر الفترة ليُعاد
     * بيعها، والملغى كذلك.
     */
     ...
     *
     * «مسدد كامل» ليست منها: المبلغ اكتمل والموعد لم يأتِ بعد، فالتذكير به
     * قائم، وإلغاؤه أو تأجيله وارد. وهي اليوم مكمّلة BLOCKING_STATUSES
     * بالصدفة لا بالتعريف — السؤالان مختلفان: أيشغل الوحدة؟ وأانتهى مساره؟
     */
    public const CLOSED_STATUSES = ['postponed', 'cancelled'];
    ...
    /**
     * هل انتهى مسار الحجز؟ (أُجِّل أو أُلغي)
     */
    ...
    /**
     * الحجوزات التي تشغل الوحدة (تُستثنى المؤجلة والملغاة).
     */
